...
def getBLAnalysisResultsURL(
    ...
    if "domain-id" in advanced:
        ...
        my_headers = {"Authorization": "Basic {}".format(authString)}
...
if rc == 0:
    ...
    print(
        "::set-output name=message::The downloaded model does not support any of the discovered languages."
    )
elif rc == 13:
    ...
    print(
        "::set-output name=message::Baseline analysis not permitted for current user."
    )
elif rc == 17:
    print(
        "::set-output name=message::Delivery analysis not permitted for current user."
    )
elif rc == 18:
    ...
    print(
        "::set-output name=message::Delivery analysis not permitted: baseline analysis not found."
    )
elif rc == 31:
